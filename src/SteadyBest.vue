...
export default {
  ...
  watch: {
    ...
    $route: function () {
      ...
      this.$nextTick(function(){
        this.getSteadyBest(this.$route.params.categoryCode,this.currentPage)
      })
    }
  },
  created(){
  ...
  methods: {
    getSteadyBest(categoryCode,page) {
      let rPage = page - 1
      this.apiModel.getSteadyBest(categoryCode,rPage).then((result)=>{
